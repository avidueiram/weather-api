...
La API cuenta con un endpoint para obtener el pronóstico semanal para una ciudad de Chile.
...
Otro punto a considerar es el uso de una base de datos H2 en memoria con el fin de guardar las ciudades disponibles para consulta, la cual, en un caso más real, debiera ser una de tipo persistente.
...
## Swagger
Para revisar la API, ejecutar el proyecto e ir a http://localhost:8080/swagger-ui.html
